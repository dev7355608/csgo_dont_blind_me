...
pyinstaller --console --onefile -y --runtime-hook=hook.py --add-data=settings.ini.default;. --add-data=gamestate_integration_dont_blind_me.cfg.template;. --add-data=INSTALL.txt;. app.py
